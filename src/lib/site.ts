...
export const pages = ['', 'experiences', 'business', 'trips', 'visit', 'offers', 'privacy'];
export const titles: Record<string, {ar: string; en: string}> = {
  ...
  business: {ar:'الأعمال والشركات', en:'Business & companies'},
  trips: {ar:'الرحلات والمجموعات', en:'Trips & group visits'},
